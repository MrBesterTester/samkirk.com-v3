---
name: ingest-todo
description: Parse a samkirk-v3 Dylan Davis TODO document into one do-work REQ per unchecked step, preserving blueprint guidance and source metadata. Use when the user asks to ingest a TODO into the queue.
---
