---
name: sync-todo
description: Sync completed samkirk-v3 do-work REQs back to their source TODO checkboxes using source_step and source_doc metadata. Use after queue processing or when the user asks to sync TODO status.
---
