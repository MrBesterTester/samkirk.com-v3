---
timestamp: 2026-02-19T08:07:03-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: fail
---

# Test Run: 2026-02-19 08:07:03 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | FAILED | 1291 | 0 | 2 | 18s |
| E2E Tests | FAILED | 23 | 32 | 0 | 1m 57s |
| E2E Real LLM | FAILED | 1 | 0 | 0 | 12s |
| GCP Smoke | FAILED | 1 | 1 | 0 | 2s |
| **Total** | | **1316** | **33** | **2** | **2m 30s** |
