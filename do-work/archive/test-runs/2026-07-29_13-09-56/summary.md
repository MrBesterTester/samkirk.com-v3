---
timestamp: 2026-07-29T13:09:56-08:00
gcp_available: false
suites_run: [unit, e2e]
overall: fail
---

# Test Run: 2026-07-29 13:09:56 PST

## Summary

| Suite | Status | Passed | Failed | Files Failed | Skipped | Duration |
|-------|--------|--------|--------|--------------|---------|----------|
| Unit Tests | PASSED | 1374 | 0 | 0 | 2 | 14s |
| E2E Tests | FAILED | 23 | 35 | 0 | 0 | 2m 29s |
| E2E Real LLM | SKIPPED | 0 | 0 | 0 | 0 | 0ms |
| GCP Smoke | SKIPPED | 0 | 0 | 0 | 0 | 0ms |
| **Total** | | **1397** | **35** | **0** | **2** | **2m 43s** |
...
| src/lib/interview-chat.test.ts | Constants, stripChunkReferences, buildInterviewSystemPrompt, generateTranscript, processMessage, validation, turn limit, guardrails, successful message processing, error handling, citations handling, getOrCreateConversation, InterviewChatError |
...
| src/lib/vertex-truncation.test.ts | assertResponseComplete |
...
No fixtures were updated during this run.
