---
timestamp: 2026-02-16T17:54:27-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: fail
---

# Test Run: 2026-02-16 17:54:27 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | PASSED | 1284 | 0 | 0 | 13s |
| E2E Tests | FAILED | 24 | 31 | 0 | 1m 51s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 34s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 39s |
| **Total** | | **1455** | **31** | **0** | **3m 19s** |
