---
timestamp: 2026-09-02T20:18:22-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: pass
---

# Test Run: 2026-09-02 20:18:22 PST

## Summary

| Suite | Status | Passed | Failed | Files Failed | Skipped | Duration |
|-------|--------|--------|--------|--------------|---------|----------|
| Unit Tests | PASSED | 1428 | 0 | 0 | 0 | 9s |
| E2E Tests | PASSED | 66 | 0 | 0 | 0 | 1m 55s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 0 | 1m 4s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 0 | 44s |
| **Total** | | **1641** | **0** | **0** | **0** | **3m 53s** |

## Test Index

| File | Describe Blocks |
|------|-----------------|
| src/app/admin/(protected)/dance-menu/page.test.tsx | Admin dance-menu upload |
| src/app/api/dance-menu/route.test.ts | GET /api/dance-menu |
...
| src/app/machine-learning/page.test.tsx | Machine Learning page |
| src/app/page.test.tsx | Home page |
| src/app/robotics/page.test.tsx | Robotics page |
...
| src/components/hire-me/JobContextBar.test.tsx | JobContextBar |
| src/hooks/useHireMe.test.ts | useHireMe, answerFitQuestion, run duration |
| src/lib/analytics-gate.test.ts | shouldLoadAnalytics |
| src/lib/analytics.test.ts | analytics, trackEvent, event names, helpers |
...
| src/lib/commute.test.ts | lookupFallbackCommute, estimateCommute |
...
| src/lib/file-preview.test.ts | previewOf |
...
| src/lib/fit-flow.test.ts | fit-flow constants, createInitialExtractedFields, createInitialFitFlowState, extractSeniority, extractLocationType, evaluateLocationFit, onsite positions, hybrid positions, applyWorstCaseLocation, generateNextQuestion, nextQuestion, follow-up counting, processAnswer, applyAnswerToExtracted, location answers, onsite frequency answers, seniority answers, skills answers, estimateCommuteFromLocation, initializeFitFlow, finalizeForReport, isReadyForReport, getUnknownFields, full flow scenarios, extractJobTitle, extractCompanyName, extractMustHaveSkills, analyzeJobText, extractJobTitle - the  |
...
| src/lib/gcp-credentials.test.ts | getGcpCredentials |
| src/lib/interview-chat.test.ts | Constants, stripChunkReferences, buildInterviewSystemPrompt, generateTranscript, processMessage, truncation labelling, validation, turn limit, guardrails, successful message processing, error handling, citations handling, getOrCreateConversation, InterviewChatError |
...
| src/lib/static-html.test.ts | static-html, scopeSelectorList, scopeCss, parseStaticHtml, dedupeLeadingHeading, end-to-end scoping of a realistic document |
...
| src/lib/tool-protection.test.ts | tool-protection module, withToolProtection, session checks, captcha checks, rate limit checks, spend cap checks, success path, skipRateLimit option, skipSpendCap option, both skip options combined, short-circuit behavior, options defaults |
...
| src/lib/vertex-truncation.test.ts | assertResponseComplete, billableOutputTokens |
| e2e/download-buttons.spec.ts | Download Buttons - Distinct Reports |
| e2e/fit-tool.spec.ts | Fit Tool Happy Path, Fit Tool Error Handling |
| e2e/full-app.spec.ts | Public Pages - Render Correctly, Machine Learning & Robotics Pages - Render Correctly, Exploration Pages - Render Correctly, Admin Pages - Authentication Required, Navigation - Links Work, API Endpoints - Basic Health, Error Handling - 404 Pages, Accessibility - Basic Checks |
| e2e/home-ctas.spec.ts | Home page — Book a Call, Home page — Interview me NOW |
