---
timestamp: 2026-02-16T18:01:25-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: fail
---

# Test Run: 2026-02-16 18:01:25 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | PASSED | 1284 | 0 | 0 | 17s |
| E2E Tests | FAILED | 24 | 31 | 0 | 1m 50s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 35s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 39s |
| **Total** | | **1455** | **31** | **0** | **3m 22s** |
