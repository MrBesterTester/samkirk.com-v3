---
timestamp: 2026-07-14T14:20:16-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: fail
---

# Test Run: 2026-07-14 14:20:16 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | FAILED | 1309 | 0 | 2 | 8s |
| E2E Tests | FAILED | 2 | 56 | 0 | 21s |
| E2E Real LLM | FAILED | 1 | 0 | 0 | 10s |
| GCP Smoke | FAILED | 1 | 1 | 0 | 1s |
| **Total** | | **1313** | **57** | **2** | **42s** |
