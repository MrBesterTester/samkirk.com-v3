---
timestamp: 2026-02-18T15:29:53-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: pass
---

# Test Run: 2026-02-18 15:29:53 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | PASSED | 1293 | 0 | 0 | 12s |
| E2E Tests | PASSED | 55 | 0 | 0 | 53s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 23s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 26s |
| **Total** | | **1495** | **0** | **0** | **1m 55s** |
