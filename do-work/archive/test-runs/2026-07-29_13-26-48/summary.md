---
timestamp: 2026-07-29T13:26:48-08:00
gcp_available: true
suites_run: [unit, e2e]
overall: pass
---

# Test Run: 2026-07-29 13:26:48 PST

## Summary

| Suite | Status | Passed | Failed | Files Failed | Skipped | Duration |
|-------|--------|--------|--------|--------------|---------|----------|
| Unit Tests | PASSED | 1376 | 0 | 0 | 0 | 12s |
| E2E Tests | PASSED | 58 | 0 | 0 | 0 | 1m 53s |
| E2E Real LLM | SKIPPED | 0 | 0 | 0 | 0 | 0ms |
| GCP Smoke | SKIPPED | 0 | 0 | 0 | 0 | 0ms |
| **Total** | | **1434** | **0** | **0** | **0** | **2m 5s** |
...
_1 fixture(s) updated during this run._
