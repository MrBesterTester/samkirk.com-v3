---
timestamp: 2026-08-31T17:50:45-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: pass
---

# Test Run: 2026-08-31 17:50:45 PST

## Summary

| Suite | Status | Passed | Failed | Files Failed | Skipped | Duration |
|-------|--------|--------|--------|--------------|---------|----------|
| Unit Tests | PASSED | 1422 | 0 | 0 | 0 | 9s |
| E2E Tests | PASSED | 66 | 0 | 0 | 0 | 2m 6s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 0 | 1m 32s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 0 | 42s |
| **Total** | | **1635** | **0** | **0** | **0** | **4m 30s** |
