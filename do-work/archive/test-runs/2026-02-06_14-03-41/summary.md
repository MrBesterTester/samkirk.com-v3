---
timestamp: 2026-02-06T14:03:41-08:00
triggered_by: UR-002/REQ-023
gcp_available: true
suites_run: [unit]
overall: fail
---

# Test Run: 2026-02-06 14:03:41 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | FAILED | 1227 | 1 | 3 | 11s |
...
- Triggered by: UR-002/REQ-023
- Raw logs: unit-tests.log (gitignored, local only)
