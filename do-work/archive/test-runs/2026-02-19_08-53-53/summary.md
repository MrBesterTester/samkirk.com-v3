---
timestamp: 2026-02-19T08:53:53-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: pass
---

# Test Run: 2026-02-19 08:53:53 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | PASSED | 1293 | 0 | 0 | 11s |
| E2E Tests | PASSED | 55 | 0 | 0 | 1m 11s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 25s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 26s |
| **Total** | | **1495** | **0** | **0** | **2m 16s** |
