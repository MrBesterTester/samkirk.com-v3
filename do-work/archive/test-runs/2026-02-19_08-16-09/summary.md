---
timestamp: 2026-02-19T08:16:09-08:00
gcp_available: true
suites_run: [unit, e2e, e2e-real, smoke]
overall: fail
---

# Test Run: 2026-02-19 08:16:09 PST

## Summary

| Suite | Status | Passed | Failed | Skipped | Duration |
|-------|--------|--------|--------|---------|----------|
| Unit Tests | PASSED | 1293 | 0 | 0 | 13s |
| E2E Tests | FAILED | 54 | 1 | 0 | 4m 39s |
| E2E Real LLM | PASSED | 39 | 0 | 0 | 28s |
| GCP Smoke | PASSED | 108 | 0 | 0 | 30s |
| **Total** | | **1494** | **1** | **0** | **5m 52s** |
