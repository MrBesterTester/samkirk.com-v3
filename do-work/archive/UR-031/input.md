---
id: UR-031
title: "Ingest: security TODO (5 steps)"
created_at: 2026-02-16T12:00:00-08:00
requests: [REQ-095, REQ-096, REQ-097, REQ-098, REQ-099]
word_count: 650
---
...
## Summary
Ingested 5 unchecked steps from docs/security-TODO.md into do-work REQ files.
...
|----|------|-------|------------|
| REQ-095 | 1.1 | Remove NODE_ENV from CAPTCHA bypass condition | Sonnet 4 |
| REQ-096 | 2.1 | Create withToolProtection() wrapper | Codex/Opus |
| REQ-097 | 2.2 | Migrate all 5 tool routes | Codex/Opus |
| REQ-098 | 3.1 | Create spend estimation validation script | Codex/Opus |
| REQ-099 | 4.1 | Configure GCP Billing Budget | Manual (You) |
