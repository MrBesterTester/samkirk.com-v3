  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400">
        Upload and publish the weekly dance menu bundle.
      </p>

      <div className="mt-12 rounded-xl border border-zinc-200 bg-zinc-50 p-8 dark:border-zinc-800 dark:bg-zinc-900">
        <p className="text-center text-zinc-500 dark:text-zinc-400">
          Dance menu upload functionality will be implemented here. Upload
          files in multiple formats (.md, .txt, .html) to publish a new menu.
        </p>
      </div>
    </div>
  );
